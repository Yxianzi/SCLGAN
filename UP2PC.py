    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(1,num_iter):
            ...
            if train_generator:
                ...
                predict1_g = predict2_g = predict3_g = None
            ...
            if train_generator:
                ...
                loss_gen_semantic = loss_gen_preserve.detach().new_tensor(0.0)
            ...
            if train_generator:
                ...
                weighted_gen_semantic = loss_gen_semantic.detach().new_tensor(0.0)
            loss = (
                cls_loss
