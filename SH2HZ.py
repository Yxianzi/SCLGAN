...
import time
import utils
from utils import sample_gt,set_requires_grad
...
for iDataSet in range(nDataSet):
    ...
    for epoch in range(1, epochs + 1):
        ...
        print(
            'epoch {:>3d}:   cls loss: {:6.4f}, occ loss:{:6f},con_s loss:{:6f}, con_t loss:{:6f},acc {:6.4f},loss_min:{:6.4f}, cal_loss:{:6.4f},total loss: {:6.4f}'
        ...
        if epoch % 10 == 0 or epoch == epochs:
            ...
            with torch.no_grad():
                for test_datas, test_labels in test_loader:
                    ...
                    #print(test_features.shape,test_outputs.shape)
...
for i in range(best_G.shape[0]):
    ...
    utils.classification_map(hsi_pic[4:-4, 4:-4, :], best_G[4:-4, 4:-4], 24,  "/tmp/pycharm_project_566/SH2HZ_map")
